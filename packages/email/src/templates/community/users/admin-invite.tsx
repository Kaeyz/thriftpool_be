...
const AdminInviteEmail = (props: AdminInviteProps) => (
  <CommunityEmailLayout>
    <Text style={communityEmailStyles.h3}>Invitation to Nehemax Admin Portal</Text>
    <Text style={communityEmailStyles.paragraph}>Hi there,</Text>
    <Text style={communityEmailStyles.paragraph}>
      You’ve been invited to join the <span style={{ fontWeight: "600" }}>Nehemax Admin Portal</span>. To get started, accept your
      invite and set up your account
    </Text>
